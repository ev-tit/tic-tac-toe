...
public class GameBoard extends GamePanel {	
	...
	public GameBoard(GameController gc) {
		...
		Font markf = new Font("SansSerif", Font.BOLD,50);
		textfield.setText("O's Turn");
		textfield.setFont(markf);
		
		plMoves.setLayout(new BorderLayout());
		plMoves.setBounds(0,0,this.getWidth(),100);
		plMoves.add(textfield);
		this.add(plMoves, BorderLayout.NORTH);
